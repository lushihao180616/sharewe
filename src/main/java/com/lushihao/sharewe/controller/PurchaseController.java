...
public class PurchaseController {
	...
	public @ResponseBody String sendPurchase(HttpServletRequest request, HttpServletResponse response,
	...
	public @ResponseBody String getPurchases(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
	...
	public @ResponseBody String getPurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
	...
	public @ResponseBody String filterPurchases(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
		int num = wxRequestJson.getInt("num");
		int page = wxRequestJson.getInt("page");
	...
	public @ResponseBody String getSendPurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
	...
	public @ResponseBody String getGetPurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
	...
	public @ResponseBody String removePurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
	...
	public @ResponseBody String sendCanclePurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
		int purchaseId = wxRequestJson.getInt("purchaseId");
	...
	public @ResponseBody String getCanclePurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
		int purchaseId = wxRequestJson.getInt("purchaseId");
	...
	public @ResponseBody String getCompletePurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
		int purchaseId = wxRequestJson.getInt("purchaseId");
	...
	public @ResponseBody String sendCompletePurchase(HttpServletRequest request, HttpServletResponse response,
			@RequestBody String data) {
		JSONObject wxRequestJson = JSONObject.fromObject(data);
		int purchaseId = wxRequestJson.getInt("purchaseId");
